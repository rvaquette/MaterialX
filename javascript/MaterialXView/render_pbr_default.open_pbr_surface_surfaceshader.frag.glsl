...
uniform float specular_roughness_anisotropy;
...
uniform float subsurface_scatter_anisotropy;
...
uniform float coat_roughness_anisotropy;
...
void main()
{
    ...
    out1 = vec4(mx_srgb_encode(open_pbr_surface_surfaceshader_out.color), 1.0);
}
